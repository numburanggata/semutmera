...
<div id="id-log-in-form-div" style="display: none; text-align:center;">
	<form 	action="index.php?page=login.php"
		...
		<table>
			...
			<!-- Jon, password admin udh sy ganti sesuai file fasttrack.txt kemarin, sy jamin aman 
soalnya 
kombinasi karakternya OP. Janlup hapus comment ini sebelum push ke production ya!-->
			</tr>
			<tr><td></td></tr>
			<tr>
